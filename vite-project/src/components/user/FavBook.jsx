  ...
  return (
    <div>
      <div>
        <div className="py-5">
          {/* text  */}
          <h1 className=" text-xl text-indigo-300 font-bold">Favorite Books</h1>
        </div>
          ...
          <table className="w-full text-left border border-collapse sm:border-separate border-indigo-100 text-indigo-400">
            <tbody>
              ...
              <tr className="text-indigo-300">
                ...
                <td className="h-12 px-6 text-md transition duration-300 border-t border-l first:border-l-0 border-indigo-100 stroke-slate-500 text-slate-500 text-red-500 cursor-pointer ">
                  Delete
                </td>
              </tr>
            </tbody>
